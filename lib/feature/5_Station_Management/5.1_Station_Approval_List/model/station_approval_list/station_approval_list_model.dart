...
class StationApprovalListModel {
  int? stationId;
  String? avatar;
  String? stationCode;
  String? stationName;
  ...
  factory StationApprovalListModel.fromMap(Map<String, dynamic> map) {
    return StationApprovalListModel(
  ...
  factory StationApprovalListModel.fromJson(Map<String, dynamic> source) =>
      StationApprovalListModel.fromMap(source);
}
